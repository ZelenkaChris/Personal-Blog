...
var PortfolioPage = createReactClass({
  render() {
    return(
      <div className="container" id="content">
        ...
        <ListGroup>
          <ListGroupItem href="http://www.zelenkachris.com:3001/cs160" target="_blank">
          ...
          <ListGroupItem href="http://www.zelenkachris.com:3001/iidx" target="_blank">
          ...
          <ListGroupItem href="http://www.zelenkachris.com/pages/game/" target="_blank">
            <h3>3D Game</h3>
          ...
          <ListGroupItem href="http://www.zelenkachris.com/pages/ASTROv3noSound/" target="_blank">
          ...
          <ListGroupItem href="https://github.com/ZelenkaChris/Minesweeper" target="_blank">
